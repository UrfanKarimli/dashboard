<template>
  <div class=" flex items-center gap-3 relative ">
    ...
    <div class=" flex flex-col items-center">
      <span class="text-sm font-bold text-[#404040] truncate">
        Ürfan Kərimli
      </span>
      <span class=" text-xs font-semibold text-[#565656]"> Admin</span>
    </div>
    <div @click="toggleProfile"
      class=" closeprofile border border-[#5C5C5C] rounded-full h-5 w-5 flex items-center justify-center cursor-pointer">
        ...
        <li>
          <RouterLink  to="/">
            <div class="flex items-center gap-2 pl-5 "
              ...
              <span class=" text-sm text-[#404040] font-semibold ">Hesabı idarə et</span>
            </div>
          </RouterLink>
        </li>
      </ul>
